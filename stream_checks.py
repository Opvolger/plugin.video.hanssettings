...
def worker():
    ...
    while True:
        ...
        try:
            ...
            stream.debug_format("Failed to connect - StatusCodeCheck - " + stream.stream_label)
        except:
            stream.debug_format("Error - StatusCodeCheck - " + stream.stream_label)
        ...
        try:
            ...
            stream.debug_format( "Timeout - FFProbeCheck - " + stream.stream_label)
        except:
            stream.debug_format("Error - FFProbeCheck - " + stream.stream_label)
        ...
        try:
            ...
            stream.debug_format("Failed to connect - M3u8RedirectOr302 - " + stream.stream_label)
        except:
            stream.debug_format("Error - M3u8RedirectOr302 - " + stream.stream_label)
